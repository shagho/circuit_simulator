...
# create Buttons
buttonnamelist = ["Resistor", "Capacitor", "Inductor", "Voltage source", "Current source", "Ground"]
buttonlist = []
...
def initalize():
    ...
    pygame.display.set_caption("Circuit Simulator : " + title)
    # create component dictionary
    compdict = {0: None, 1: resistoricon, 2: capacitoricon, 3: inductoricon, 5: vsourceicon,
                6: csourceicon, 7: gndicon, 8: resistoricon, }
    typedict = {1: 'R', 2: 'C', 3: 'L', 5: 'V', 6: 'I', 7: 'G', 8: 'g'}
    gridspace = 25
    linethickness = 3
    lineColor = (0, 255, 255)
...
def render():
    ...
    # openButton.create_button(gameDisplay, (192, 192, 192), 690, 0, 150, 50, 0, "open", (0, 0, 0))
    newButton.create_button(gameDisplay, (192, 192, 192), 765, 0, 150, 50, 0, "New", (0, 0, 0))
    saveButton.create_button(gameDisplay, (192, 192, 192), 690, 55, 150, 50, 0, "Save", (0, 0, 0))
    changetitleButton.create_button(gameDisplay, (192, 192, 192), 845, 55, 150, 50, 0, "Change Title", (0, 0, 0))
    startsimButton.create_button(gameDisplay, (192, 192, 192), 690, 110, 150, 50, 0, "Start simulation", (0, 0, 0))
    netlistButton.create_button(gameDisplay, (192, 192, 192), 845, 110, 150, 50, 0, "Netlist", (0, 0, 0))
    rotateButton.create_button(gameDisplay, (192, 192, 192), 690, 165, 150, 50, 0, "Rotate", (0, 0, 0))
    deleteButton.create_button(gameDisplay, (192, 192, 192), 845, 165, 150, 50, 0, "Delete", (0, 0, 0))
    resistorButton.create_button(gameDisplay, (192, 192, 192), 690, 220, 150, 50, 0, "Resistor", (0, 0, 0))
    vsourceButton.create_button(gameDisplay, (192, 192, 192), 845, 220, 150, 50, 0, "Voltage source", (0, 0, 0))
    csourceButton.create_button(gameDisplay, (192, 192, 192), 690, 275, 150, 50, 0, "Current source", (0, 0, 0))
    gndButton.create_button(gameDisplay, (192, 192, 192), 845, 275, 150, 50, 0, "Ground", (0, 0, 0))
    ACButton.create_button(gameDisplay, (192, 192, 192), 690, 330, 150, 50, 0, "AC", (0, 0, 0))
    DCButton.create_button(gameDisplay, (192, 192, 192), 845, 330, 150, 50, 0, "DC", (0, 0, 0))
    capacitorButton.create_button(gameDisplay, (192, 192, 192), 690, 385, 150, 50, 0, "Capacitor", (0, 0, 0))
    inductorButton.create_button(gameDisplay, (192, 192, 192), 845, 385, 150, 50, 0, "Inductor", (0, 0, 0))
    # diodeButton.create_button(gameDisplay, (192, 192, 192), 600, 0, 200, 40, 0, "Diode", (0, 0, 0))
    # conductanceButton.create_button(gameDisplay, (192, 192, 192), 400, 40, 200, 40, 0, "Conductance", (0, 0, 0))
    # opampButton.create_button(gameDisplay, (192, 192, 192), 600, 40, 200, 40, 0, "OPAMP", (0, 0, 0))
    # sweepButton.create_button(gameDisplay, (192, 192, 192), 800, 80, 200, 40, 0, "Sweep", (0, 0, 0))
    # graphButton.create_button(gameDisplay, (192, 192, 192), 400, 120, 200, 40, 0, "Graph", (0, 0, 0))
    ...
    if drawingLine:
        if abs(initialCoordinates[0] - gridCoordinates[0]) >= abs(initialCoordinates[1] - gridCoordinates[1]):
            ...
            pygame.draw.line(gameDisplay, lineColor, initialCoordinates, [gridCoordinates[0], initialCoordinates[1]],
                             linethickness)
        else:
            componentOrientationRender = 1
            pygame.draw.line(gameDisplay, lineColor, initialCoordinates, [initialCoordinates[0], gridCoordinates[1]],
                             linethickness)
    ...
    if drawingComponenet:
        ...
        if currentComponent != 9:
            if componentOrientationRender == 0:
                gameDisplay.blit(compdict[currentComponent],
                                 (gridCoordinates[0] - (compheight / 2) + 1, gridCoordinates[1]))
        ...
        if currentComponent == 9:
            if componentOrientationRender == 0:
                gameDisplay.blit(compdict[currentComponent],
                                 (gridCoordinates[0] - (compheight / 2), gridCoordinates[1] - (compwidth)))
            if componentOrientationRender == 1:
                compimage = pygame.transform.rotate(compdict[currentComponent], 270)
                gameDisplay.blit(compimage, (gridCoordinates[0], gridCoordinates[1] - (compheight / 2) + 1))
    # Render components
                        ...
                        if n != c:
                            if findCollisionWireWire(n, c)[0]:
                                if findCollisionWireWire(n, c)[1] != None:
                                    joint = pygame.draw.rect(gameDisplay, (0, 0, 200), (
                                        findCollisionWireWire(n, c)[1][0] - 3, findCollisionWireWire(n, c)[1][1] - 3, 8,
                                        8),
                                                             0)
                                    joint.center = (
                                        findCollisionWireWire(n, c)[1][0], findCollisionWireWire(n, c)[1][1])
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if csourceButton.pressed(pygame.mouse.get_pos()):
                return eventType.Key_Down, "i"
            # if openButton.pressed(pygame.mouse.get_pos()):
            #     return eventType.Key_Down, "o"
            ...
            # if openButton.pressed(pygame.mouse.get_pos()):
            #     return eventType.Key_Down, "open"
...
def loadFile(fileName):
    ...
    for i in range(componentCount):
        ...
        print('-----')
        components.append(
            [componentType, componentOrientation, componentCoordx, componentCoordy, componentName, componentValue])
        print(components)
...
#     # name, _ = QtWidgets.QFileDialog.getOpenFileName(None, 'Open File',
...
#     file_path = askForValue("Enter file value : ")
#     loadFile(file_path)
# render()

def generateNetlistForSimulaton():
    global nodes
    global status
...
def detectCollision(component, Coordinates):
    ...
    if (component[0] != 0):
        ...
        if (component[1] == 0 or component[1] == 2):
            if component[0] != 9:
                comprect = pygame.draw.rect(gameDisplay, (255, 255, 255),
                                            (c[2] - compheight / 2, c[3], compheight, compwidth), 1)
                pygame.display.flip()
            else:
                comprect = pygame.draw.rect(gameDisplay, (255, 255, 255),
                                            (c[2] - compheight / 2, c[3] - compwidth, compheight, compwidth), 1)
                pygame.display.flip()
        elif (component[1] == 1 or component[1] == 3):
            if component[0] != 9:
                comprect = pygame.draw.rect(gameDisplay, (255, 255, 255),
                                            (c[2], c[3] - compheight / 2, compwidth, compheight), 1)
                pygame.display.flip()
            else:
                comprect = pygame.draw.rect(gameDisplay, (255, 255, 255),
                                            (c[2], c[3] - compheight / 2, compwidth, compheight), 1)
    ...
    # detect wire collision
        ...
        if component[1] == 1:
            line = pygame.draw.line(gameDisplay, (255, 255, 255), [component[2], component[3]],
                                    [component[2] + component[5], component[3]], 2)
        elif component[1] == 0:
            line = pygame.draw.line(gameDisplay, (255, 255, 255), [component[2], component[3]],
                                    [component[2], component[3] + component[5]], 2)
...
def Startsimulation():
    global status
    global Analyze
    flag = generateNetlistForSimulaton()
    if flag:
...
while not killApp:
    ...
    # update grid coordinates every time the mouse moves
        ...
        gridCoordinates = [snapToGrid(eventParameter[0], eventParameter[1], 25)[0],
                           snapToGrid(eventParameter[0], eventParameter[1], 25)[1]]
    ...
    # when mouse up
        ...
        if (deletemode == False) and (graphMode == False):
            ...
            # or save drawn component
                ...
                drawingComponenet = False
                components.append(
                    [currentComponent, componentOrientationRender * 3, gridCoordinates[0], gridCoordinates[1],
